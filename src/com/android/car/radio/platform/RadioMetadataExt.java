...
public class RadioMetadataExt {
     ...
     */
    static void setModuleId(int id) {
        mModuleId = id;
    }

    /* getBitmapId isn't part of the system API yet, so we can skip deprecation here and jump
     * straight to the correct solution.
     */
    public static long getGlobalBitmapId(@NonNull RadioMetadata meta, @NonNull String key) {
         ...
         */
        return ((long)mModuleId << 32) | localId;
    }
}
